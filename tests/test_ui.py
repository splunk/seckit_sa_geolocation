...
def test_web_accessible(eyes, driver,splunk_web_uri):
    ...
    eyes.open(driver, "SecKit_Geolocation", "Web Accessible", {"width": 800, "height": 600})
    # Navigate the browser to the "hello world!" web-site.
    driver.get(f"{splunk_web_uri}")
...
def test_web_login_success(eyes, driver,splunk_web_uri):
    # Start the test and set the browser's viewport size to 800x600.
    eyes.open(driver, "SecKit_Geolocation", "Web Login", {"width": 800, "height": 600})
    # Navigate the browser to the "hello world!" web-site.
    ...
    eyes.check("Login Success", Target.window())
