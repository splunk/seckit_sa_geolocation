        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(mode='w', suffix=".conf", prefix="GeoIP") as file:
                    ...
                    try:
                        ...
                        ["$SPLUNK_HOME/etc/apps/SecKit_SA_geolocation/bin/geoipupdate/linux_amd64/geoipupdate " + guargs], shell=False,stderr=subprocess.STDOUT) # nosemgrep: python.lang.security.audit.dangerous-subprocess-use
