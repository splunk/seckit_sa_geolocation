...
def reload_data_input_ns(splunkd_uri, session_key, owner, app_name,
                         input_type):
    """
...
def create_data_input_ns(splunkd_uri, session_key, owner, app_name, input_type,
...
def get_data_input_ns(splunkd_uri, session_key, owner, app_name, input_type,
                      name=None):
    """
    :param splunkd_uri: splunkd uri, e.g. https://127.0.0.1:8089
    :param session_key: splunkd session key
...
def update_data_input_ns(splunkd_uri, session_key, owner, app_name, input_type,
                         name, key_values):
    """
    :param splunkd_uri: splunkd uri, e.g. https://127.0.0.1:8089
    :param session_key: splunkd session key
...
def delete_data_input_ns(splunkd_uri, session_key, owner, app_name, input_type,
                         name):
    """
    :param splunkd_uri: splunkd uri, e.g. https://127.0.0.1:8089
    :param session_key: splunkd session key
...
def operate_data_input_ns(splunkd_uri, session_key, owner, app_name,
                          input_type,
                          name, operation):
    """
    :param splunkd_uri: splunkd uri, e.g. https://127.0.0.1:8089
